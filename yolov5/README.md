CUDA_VISIBLE_DEVICES=3 python val.py --data coco.yaml --img 640 --conf 0.001 --iou 0.65 --weights /data/fhl/yolov5_latest/models/yolov5s.pt

python export.py --weights /data/fhl/yolov5-master/models/yolov5s.pt --img 640 --dynamic --include onnx

trtexec 指定fp16的意思是能用fp16的算子就会用fp16，而不能用的会继续用fp32，同理--int8，优先是int8，不能用的层或算子会用fp32.

/data/fhl/TensorRT-8.6.1.6/bin/trtexec --onnx=/data/fhl/yolov5-master/models/yolov5s.onnx --saveEngine=/data/fhl/yolov5-master/models/yolov5s_int8.engine --explicitBatch --minShapes=images:1x3x256x256 --optShapes=images:8x3x640x640 --maxShapes=images:32x3x1024x1024 --int8

CUDA_VISIBLE_DEVICES=3 python val.py --data coco.yaml --img 640 --conf 0.001 --iou 0.65 --weights /data/fhl/yolov5-master/models/yolov5s_int8.engine

CUDA_VISIBLE_DEVICES=3 python val.py --data coco.yaml --img 640 --conf 0.001 --iou 0.65 --weights /data/fhl/yolov5_latest/models/yolov5s-int8-32-16-minmax_success.engine

CUDA_VISIBLE_DEVICES=3 python val.py --data coco.yaml --img 640 --conf 0.001 --iou 0.65 --weights /data/fhl/yolov5-master/models/yolov5s_skip4.engine

CUDA_VISIBLE_DEVICES=3 python val.py --data coco.yaml --img 672 --conf 0.001 --iou 0.65 --weights /data/fhl/yolov5-7.0/models/yolov5_trimmed_qat_672_noanchor_noqdq.engine
